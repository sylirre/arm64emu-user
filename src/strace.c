...
static const struct { u16 nr; u8 t[6]; u8 rt; } argdefs[] = {
    ...
    /* preadv2/pwritev2 pass the offset in pos_l (a3); pos_h (a4) is 0 on the
     * LP64 guest, and the RWF_* flags ride in a5 — all shown raw. */
    { G_NR_preadv2,   { AT_FD, AT_PTR, AT_INT, AT_INT, AT_HEX, AT_HEX }, 0 },
    { G_NR_pwritev2,  { AT_FD, AT_PTR, AT_INT, AT_INT, AT_HEX, AT_HEX }, 0 },
    { G_NR_sendfile,  { AT_FD, AT_FD, AT_PTR, AT_UINT }, 0 },
    { G_NR_ppoll,     { AT_PTR, AT_UINT, AT_TIMESPEC, AT_PTR, AT_UINT }, 0 },
    { G_NR_pselect6,  { AT_INT, AT_PTR, AT_PTR, AT_PTR, AT_TIMESPEC, AT_PTR }, 0 },
    { G_NR_splice,    { AT_FD, AT_PTR, AT_FD, AT_PTR, AT_UINT, AT_HEX }, 0 },
    { G_NR_copy_file_range, { AT_FD, AT_PTR, AT_FD, AT_PTR, AT_UINT, AT_HEX }, 0 },
    { G_NR_sync,      { AT_NONE }, 0 },
    { G_NR_syncfs,    { AT_FD }, 0 },
    ...
    { G_NR_inotify_add_watch, { AT_FD, AT_STR, AT_HEX }, 0 },
    { G_NR_inotify_rm_watch,  { AT_FD, AT_INT }, 0 },
    { G_NR_epoll_create1, { AT_HEX }, 0 },
    { G_NR_epoll_ctl, { AT_FD, AT_INT, AT_FD, AT_PTR }, 0 },
    { G_NR_epoll_pwait, { AT_FD, AT_PTR, AT_INT, AT_INT, AT_PTR, AT_UINT }, 0 },
    { G_NR_setxattr,  { AT_STR, AT_STR, AT_BUF_IN, AT_UINT, AT_HEX }, 0 },
    { G_NR_lsetxattr, { AT_STR, AT_STR, AT_BUF_IN, AT_UINT, AT_HEX }, 0 },
    { G_NR_fsetxattr, { AT_FD,  AT_STR, AT_BUF_IN, AT_UINT, AT_HEX }, 0 },
    { G_NR_getxattr,  { AT_STR, AT_STR, AT_PTR, AT_UINT }, 0 },
    { G_NR_lgetxattr, { AT_STR, AT_STR, AT_PTR, AT_UINT }, 0 },
    { G_NR_fgetxattr, { AT_FD,  AT_STR, AT_PTR, AT_UINT }, 0 },
    { G_NR_listxattr, { AT_STR, AT_PTR, AT_UINT }, 0 },
    { G_NR_llistxattr,{ AT_STR, AT_PTR, AT_UINT }, 0 },
    { G_NR_flistxattr,{ AT_FD,  AT_PTR, AT_UINT }, 0 },
    { G_NR_removexattr,  { AT_STR, AT_STR }, 0 },
    { G_NR_lremovexattr, { AT_STR, AT_STR }, 0 },
    { G_NR_fremovexattr, { AT_FD,  AT_STR }, 0 },
    /* memory */
    ...
    { G_NR_mincore,   { AT_PTR, AT_UINT, AT_PTR }, 0 },
    ...
    { G_NR_waitid,    { AT_INT, AT_INT, AT_PTR, AT_HEX, AT_PTR }, 0 },
    { G_NR_setpgid,   { AT_INT, AT_INT }, 0 },
    { G_NR_getpgid,   { AT_INT }, 0 },
    { G_NR_getsid,    { AT_INT }, 0 },
    { G_NR_getgroups, { AT_INT, AT_PTR }, 0 },
    { G_NR_setgroups, { AT_INT, AT_PTR }, 0 },
    { G_NR_umask,     { AT_MODE }, 0 },
    { G_NR_setresuid, { AT_INT, AT_INT, AT_INT }, 0 },
    { G_NR_setresgid, { AT_INT, AT_INT, AT_INT }, 0 },
    { G_NR_getresuid, { AT_PTR, AT_PTR, AT_PTR }, 0 },
    { G_NR_getresgid, { AT_PTR, AT_PTR, AT_PTR }, 0 },
    { G_NR_setreuid,  { AT_INT, AT_INT }, 0 },
    { G_NR_setregid,  { AT_INT, AT_INT }, 0 },
    { G_NR_setfsuid,  { AT_INT }, 0 },
    { G_NR_setfsgid,  { AT_INT }, 0 },
    { G_NR_getpriority, { AT_INT, AT_INT }, 0 },
    { G_NR_setpriority, { AT_INT, AT_INT, AT_INT }, 0 },
    { G_NR_sched_getparam, { AT_INT, AT_PTR }, 0 },
    { G_NR_sched_setparam, { AT_INT, AT_PTR }, 0 },
    { G_NR_sched_setscheduler, { AT_INT, AT_INT, AT_PTR }, 0 },
    { G_NR_sched_getscheduler, { AT_INT }, 0 },
    { G_NR_sched_getaffinity,  { AT_INT, AT_UINT, AT_PTR }, 0 },
    { G_NR_sched_setaffinity,  { AT_INT, AT_UINT, AT_PTR }, 0 },
    { G_NR_sched_get_priority_max, { AT_INT }, 0 },
    { G_NR_sched_get_priority_min, { AT_INT }, 0 },
    { G_NR_sched_rr_get_interval,  { AT_INT, AT_TIMESPEC_O }, 0 },
    { G_NR_getrusage, { AT_INT, AT_PTR }, 0 },
    { G_NR_times,     { AT_PTR }, 0 },
    { G_NR_set_robust_list, { AT_PTR, AT_UINT }, 0 },
    ...
    { G_NR_pidfd_open,  { AT_INT, AT_HEX }, 0 },
    { G_NR_pidfd_send_signal, { AT_FD, AT_SIG, AT_PTR, AT_HEX }, 0 },
    ...
    { G_NR_setitimer,      { AT_INT, AT_PTR, AT_PTR }, 0 },
    { G_NR_getitimer,      { AT_INT, AT_PTR }, 0 },
    { G_NR_timerfd_create, { AT_INT, AT_HEX }, 0 },
    { G_NR_timerfd_settime,{ AT_FD, AT_HEX, AT_PTR, AT_PTR }, 0 },
    { G_NR_timerfd_gettime,{ AT_FD, AT_PTR }, 0 },
    /* resource / misc */
    ...
    { G_NR_sysinfo,   { AT_PTR }, 0 },
    { G_NR_membarrier,{ AT_INT, AT_HEX, AT_INT }, 0 },
    { G_NR_getcpu,    { AT_PTR, AT_PTR, AT_PTR }, 0 },
    { G_NR_sethostname, { AT_STR, AT_UINT }, 0 },
    { G_NR_syslog,    { AT_INT, AT_PTR, AT_INT }, 0 },
    { G_NR_personality, { AT_HEX }, 0 },
    { G_NR_capget,    { AT_PTR, AT_PTR }, 0 },
    { G_NR_capset,    { AT_PTR, AT_PTR }, 0 },
    { G_NR_keyctl,    { AT_INT, AT_HEX, AT_HEX, AT_HEX, AT_HEX }, 0 },
    { G_NR_add_key,   { AT_STR, AT_STR, AT_PTR, AT_UINT, AT_INT }, 0 },
    { G_NR_request_key, { AT_STR, AT_STR, AT_STR, AT_INT }, 0 },
    /* sockets */
    ...
    { G_NR_setsockopt,{ AT_FD, AT_INT, AT_INT, AT_PTR, AT_UINT }, 0 },
    { G_NR_getsockopt,{ AT_FD, AT_INT, AT_INT, AT_PTR, AT_PTR }, 0 },
